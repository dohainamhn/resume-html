  ...
  return (
    ...
    >
      <svg
        ...
        style={{
          transform: "translate3d(8.34px, 19.5994px, 0px)",
          transformStyle: "preserve-3d",
          backfaceVisibility: `hidden`,
          position: `relative`,
          display: `block`,
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        style={{
          transform: "translate3d(5.56px, 13.0663px, 0px)",
          transformStyle: "preserve-3d",
          backfaceVisibility: "hidden",
          position: "absolute",
          display: "block",
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        style={{
          transform: "translate3d(16.68px, 39.1988px, 0px)",
          transformStyle: "preserve-3d",
          backfaceVisibility: "hidden",
          position: "absolute",
          display: "block",
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        style={{
          transform: "translate3d(13.9px, 32.6656px, 0px)",
          transformStyle: "preserve-3d",
          backfaceVisibility: "hidden",
          position: "absolute",
          display: "block",
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        style={{
          transform: "translate3d(11.12px, 26.1325px, 0px)",
          transformStyle: "preserve-3d",
          backfaceVisibility: "hidden",
          position: "absolute",
          display: "block",
